...
//The TimeUnit instance passed to the getDelay() method is an Enum that tells
//which time unit the delay should be returned in
public class DelayQueues {
	...
	public static void main(String[] args) {
		...
		try {
			//these can be inserted by multiple threads
